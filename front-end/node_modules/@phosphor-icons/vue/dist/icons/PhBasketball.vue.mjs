...
const g = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20ZM60,177.28A83.59,83.59,0,0,1,44.87,140H75.14A83.1,83.1,0,0,1,60,177.28ZM44.87,116A83.59,83.59,0,0,1,60,78.72,83.1,83.1,0,0,1,75.14,116ZM116,211.13a83.63,83.63,0,0,1-39-16.46A106.94,106.94,0,0,0,99.34,140H116ZM116,116H99.34A106.94,106.94,0,0,0,77,61.33a83.63,83.63,0,0,1,39-16.46Zm80-37.28A83.59,83.59,0,0,1,211.13,116H180.86A83.1,83.1,0,0,1,196,78.72ZM140,211.13V140h16.66A106.94,106.94,0,0,0,179,194.67,83.63,83.63,0,0,1,140,211.13ZM156.66,116H140V44.87a83.63,83.63,0,0,1,39,16.46A106.94,106.94,0,0,0,156.66,116ZM196,177.28A83.1,83.1,0,0,1,180.86,140h30.27A83.59,83.59,0,0,1,196,177.28Z" }, null, -1), f = [
  ...
  setup(h) {
    const a = h, r = A("weight", "regular"), Z = A("size", "1em"), d = A("color", "currentColor"), c = A("mirrored", !1), s = n(() => a.weight ?? r), i = n(() => a.size ?? Z), _ = n(() => a.color ?? d), m = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : c ? "scale(-1, 1)" : void 0);
    return (l, F) => (t(), e("svg", u({
      ...
      p(l.$slots, "default"),
      s.value === "bold" ? (t(), e("g", v, f)) : s.value === "duotone" ? (t(), e("g", V, x)) : s.value === "fill" ? (t(), e("g", S, B)) : s.value === "light" ? (t(), e("g", C, N)) : s.value === "regular" ? (t(), e("g", E, W)) : s.value === "thin" ? (t(), e("g", $, q)) : H("", !0)
    ], 16, g));
  }
});
export {
