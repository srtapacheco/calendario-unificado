...
const g = ["width", "height", "fill", "transform"], M = { key: 0 }, S = /* @__PURE__ */ e("path", { d: "M219.29,31.5a20,20,0,0,0-18.52-2.14C187,34.72,159.17,43.7,128,43.7s-59-9-72.77-14.34A20,20,0,0,0,28,48v55.77c0,36.64,9.9,71.25,27.88,97.45C74.81,228.81,100.42,244,128,244s53.19-15.19,72.12-42.76C218.1,175,228,140.43,228,103.79V48A20,20,0,0,0,219.29,31.5ZM204,103.79c0,31.84-8.41,61.63-23.67,83.87C166,208.51,147.43,220,128,220s-38-11.49-52.33-32.34C60.41,165.42,52,135.63,52,103.79v-50c16.59,5.95,44.67,13.94,76,13.94s59.41-8,76-13.94Zm-66.11,9.72a12,12,0,0,1,16.59-3.61,17.75,17.75,0,0,0,19.06,0,12,12,0,0,1,13,20.2,41.74,41.74,0,0,1-45,0A12,12,0,0,1,137.89,113.51ZM114.5,130.09a41.72,41.72,0,0,1-45,0,12,12,0,1,1,13-20.19,17.74,17.74,0,0,0,19.07,0,12,12,0,1,1,13,20.19Zm43.88,57.42a12,12,0,0,1-16.4,4.37,27.13,27.13,0,0,0-28,0,12,12,0,1,1-12-20.76,51.14,51.14,0,0,1,52,0A12,12,0,0,1,158.38,187.51Z" }, null, -1), y = [
  ...
  setup(r) {
    const c = r, d = a("weight", "regular"), _ = a("size", "1em"), h = a("color", "currentColor"), C = a("mirrored", !1), o = n(() => c.weight ?? d), i = n(() => c.size ?? _), A = n(() => c.color ?? h), m = n(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : C ? "scale(-1, 1)" : void 0);
    return (l, G) => (s(), t("svg", v({
      ...
      Z(l.$slots, "default"),
      o.value === "bold" ? (s(), t("g", M, y)) : o.value === "duotone" ? (s(), t("g", f, V)) : o.value === "fill" ? (s(), t("g", x, B)) : o.value === "light" ? (s(), t("g", N, E)) : o.value === "regular" ? (s(), t("g", P, $)) : o.value === "thin" ? (s(), t("g", j, D)) : p("", !0)
    ], 16, g));
  }
});
export {
