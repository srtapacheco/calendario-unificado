import { defineComponent as m, inject as a, computed as n, openBlock as t, createElementBlock as e, mergeProps as g, renderSlot as v, createCommentVNode as y, createElementVNode as o } from "vue";
const Z = ["width", "height", "fill", "transform"], f = { key: 0 }, A = /* @__PURE__ */ o("path", { d: "M248.9,152c-1.33-1.47-23.75-25.85-60.21-40.69-2.15-18.28-9.1-34.9-20.1-47.71C153.12,45.52,130.79,36,104,36,50.44,36,15.69,83.79,14.24,85.82a12,12,0,0,0,19.53,14C34.05,99.38,62.65,60,104,60c19.85,0,35.45,6.45,46.38,19.18a61.35,61.35,0,0,1,12.4,24A143.6,143.6,0,0,0,132.61,100c-27,0-49.79,7.13-65.85,20.63C52.3,132.79,44,149.78,44,167.25,44,193.46,63.44,220,100.61,220c51.93,0,82.34-40.28,87.87-82.43a156.46,156.46,0,0,1,42.62,30.48A12,12,0,1,0,248.9,152ZM148.37,173.74C140.09,183.9,125.09,196,100.61,196,78.08,196,68,181.56,68,167.25,68,146.42,88.22,124,132.61,124a119.85,119.85,0,0,1,32.64,4.62C164.24,145.44,158.21,161.66,148.37,173.74Z" }, null, -1), M = [
  A
  ...
  setup(r) {
    const s = r, d = a("weight", "regular"), _ = a("size", "1em"), h = a("color", "currentColor"), C = a("mirrored", !1), c = n(() => s.weight ?? d), i = n(() => s.size ?? _), u = n(() => s.color ?? h), p = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : C ? "scale(-1, 1)" : void 0);
    return (l, D) => (t(), e("svg", g({
      ...
      v(l.$slots, "default"),
      c.value === "bold" ? (t(), e("g", f, M)) : c.value === "duotone" ? (t(), e("g", w, x)) : c.value === "fill" ? (t(), e("g", z, B)) : c.value === "light" ? (t(), e("g", V, E)) : c.value === "regular" ? (t(), e("g", H, W)) : c.value === "thin" ? (t(), e("g", $, L)) : y("", !0)
    ], 16, Z));
  }
});
export {
