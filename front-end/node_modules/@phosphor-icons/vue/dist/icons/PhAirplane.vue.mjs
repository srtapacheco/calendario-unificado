...
const m = ["width", "height", "fill", "transform"], y = { key: 0 }, M = /* @__PURE__ */ o("path", { d: "M237.37,125.27,164,88.58V48a36,36,0,0,0-72,0V88.58L18.63,125.27A12,12,0,0,0,12,136v32a12,12,0,0,0,14.35,11.77L92,166.64V179L79.51,191.51A12,12,0,0,0,76,200v32a12,12,0,0,0,16.46,11.14L128,228.92l35.54,14.22A11.91,11.91,0,0,0,168,244a12,12,0,0,0,12-12V200a12,12,0,0,0-3.51-8.49L164,179V166.64l65.65,13.13A12,12,0,0,0,244,168V136A12,12,0,0,0,237.37,125.27ZM220,153.36l-65.65-13.13A12,12,0,0,0,140,152v32a12,12,0,0,0,3.51,8.49L156,205v9.31l-23.54-9.42a12,12,0,0,0-8.92,0L100,214.28V205l12.49-12.48A12,12,0,0,0,116,184V152a12,12,0,0,0-14.35-11.77L36,153.36v-9.94l73.37-36.69A12,12,0,0,0,116,96V48a12,12,0,0,1,24,0V96a12,12,0,0,0,6.63,10.73L220,143.42Z" }, null, -1), f = [
  ...
  setup(r) {
    const a = r, d = s("weight", "regular"), c = s("size", "1em"), v = s("color", "currentColor"), L = s("mirrored", !1), l = n(() => a.weight ?? d), i = n(() => a.size ?? c), A = n(() => a.color ?? v), _ = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (V, F) => (t(), e("svg", u({
      ...
      p(V.$slots, "default"),
      l.value === "bold" ? (t(), e("g", y, f)) : l.value === "duotone" ? (t(), e("g", Z, x)) : l.value === "fill" ? (t(), e("g", S, C)) : l.value === "light" ? (t(), e("g", B, b)) : l.value === "regular" ? (t(), e("g", E, W)) : l.value === "thin" ? (t(), e("g", $, q)) : g("", !0)
    ], 16, m));
  }
});
export {
