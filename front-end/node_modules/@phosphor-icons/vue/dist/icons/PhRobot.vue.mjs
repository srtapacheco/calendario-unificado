import { defineComponent as V, inject as n, computed as h, openBlock as t, createElementBlock as a, mergeProps as A, renderSlot as u, createCommentVNode as p, createElementVNode as e } from "vue";
const v = ["width", "height", "fill", "transform"], g = { key: 0 }, M = /* @__PURE__ */ e("path", { d: "M200,44H140V16a12,12,0,0,0-24,0V44H56A36,36,0,0,0,20,80V192a36,36,0,0,0,36,36H200a36,36,0,0,0,36-36V80A36,36,0,0,0,200,44Zm12,148a12,12,0,0,1-12,12H56a12,12,0,0,1-12-12V80A12,12,0,0,1,56,68H200a12,12,0,0,1,12,12Zm-48-64H92a32,32,0,0,0,0,64h72a32,32,0,0,0,0-64Zm-28,24v16H120V152Zm-52,8a8,8,0,0,1,8-8h4v16H92A8,8,0,0,1,84,160Zm80,8h-4V152h4a8,8,0,0,1,0,16ZM68,100a16,16,0,1,1,16,16A16,16,0,0,1,68,100Zm88,0a16,16,0,1,1,16,16A16,16,0,0,1,156,100Z" }, null, -1), y = [
  M
  ...
  setup(r) {
    const s = r, H = n("weight", "regular"), d = n("size", "1em"), c = n("color", "currentColor"), m = n("mirrored", !1), o = h(() => s.weight ?? H), i = h(() => s.size ?? d), Z = h(() => s.color ?? c), _ = h(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
