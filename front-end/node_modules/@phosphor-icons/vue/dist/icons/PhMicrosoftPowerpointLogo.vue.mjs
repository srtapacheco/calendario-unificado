...
const p = ["width", "height", "fill", "transform"], M = { key: 0 }, g = /* @__PURE__ */ e("path", { d: "M96,92H80a12,12,0,0,0-12,12v48a12,12,0,0,0,24,0v-4h4a28,28,0,0,0,0-56Zm0,32H92v-8h4a4,4,0,0,1,0,8ZM136,20A107.49,107.49,0,0,0,55.5,56H36A20,20,0,0,0,16,76V180a20,20,0,0,0,20,20H55.5A108,108,0,1,0,136,20Zm0,24a84.12,84.12,0,0,1,83.13,72H168V76a20,20,0,0,0-20-20H92.68A83.67,83.67,0,0,1,136,44ZM40,80H144v96H40Zm96,132a83.67,83.67,0,0,1-43.32-12H148a20,20,0,0,0,20-20V140h51.13A84.12,84.12,0,0,1,136,212Z" }, null, -1), y = [
  ...
  setup(l) {
    const s = l, H = n("weight", "regular"), c = n("size", "1em"), d = n("color", "currentColor"), Z = n("mirrored", !1), a = i(() => s.weight ?? H), h = i(() => s.size ?? c), _ = i(() => s.color ?? d), A = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (r, D) => (t(), o("svg", V({
      ...
      m(r.$slots, "default"),
      a.value === "bold" ? (t(), o("g", M, y)) : a.value === "duotone" ? (t(), o("g", f, x)) : a.value === "fill" ? (t(), o("g", S, C)) : a.value === "light" ? (t(), o("g", B, P)) : a.value === "regular" ? (t(), o("g", b, W)) : a.value === "thin" ? (t(), o("g", $, L)) : u("", !0)
    ], 16, p));
  }
});
export {
