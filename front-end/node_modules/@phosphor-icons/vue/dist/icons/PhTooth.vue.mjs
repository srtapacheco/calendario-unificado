...
const v = ["width", "height", "fill", "transform"], L = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M172.46,83.15,160.31,88l12.15,4.85a12,12,0,1,1-8.92,22.29L128,100.93,92.46,115.15a12,12,0,0,1-8.92-22.29L95.69,88,83.54,83.15a12,12,0,0,1,8.92-22.29L128,75.08l35.54-14.22a12,12,0,0,1,8.92,22.29ZM228,79.75c.08,76.45-25.2,135.68-49,152.59a20,20,0,0,1-31.44-14.92c-.67-9.06-2.33-22-6.46-32.23C135.76,172,129.92,172,128,172c-7.76,0-11.77,9.92-13.08,13.18-4.13,10.22-5.79,23.17-6.46,32.23A20,20,0,0,1,88.51,236,19.86,19.86,0,0,1,77,232.34C53.2,215.43,27.92,156.2,28,79.75A60,60,0,0,1,88,20h80A60,60,0,0,1,228,79.75Zm-24,0A36,36,0,0,0,168,44H88A36,36,0,0,0,52,79.78c-.06,61.09,17.83,109.52,33.3,127.66C91.24,156,114.32,148,128,148s36.76,8,42.7,59.43C186.17,189.31,204.06,140.88,204,79.78Z" }, null, -1), f = [
  ...
  setup(r) {
    const c = r, d = a("weight", "regular"), h = a("size", "1em"), _ = a("color", "currentColor"), A = a("mirrored", !1), s = l(() => c.weight ?? d), n = l(() => c.size ?? h), u = l(() => c.color ?? _), m = l(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), e("svg", C({
      ...
      g(i.$slots, "default"),
      s.value === "bold" ? (t(), e("g", L, f)) : s.value === "duotone" ? (t(), e("g", M, x)) : s.value === "fill" ? (t(), e("g", H, z)) : s.value === "light" ? (t(), e("g", B, b)) : s.value === "regular" ? (t(), e("g", E, V)) : s.value === "thin" ? (t(), e("g", W, j)) : Z("", !0)
    ], 16, v));
  }
});
export {
