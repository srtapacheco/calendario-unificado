...
const M = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M223.27,91.08a59.82,59.82,0,0,0-19.5-16.27A60,60,0,0,0,144,20H84A20,20,0,0,0,64.6,35.15l-36,144A20,20,0,0,0,48,204H70.39l-1.79,7.15A20,20,0,0,0,88,236h31.5a20,20,0,0,0,19.4-15.15L147.13,188H176a60,60,0,0,0,47.29-96.92ZM87.13,44H144a35.77,35.77,0,0,1,28.37,13.85A36.18,36.18,0,0,1,178,68.06c-.66,0-1.31-.06-2-.06H120A20,20,0,0,0,100.6,83.15L76.39,180H53.13Zm90.76,48.05A35.93,35.93,0,0,1,144,116H117.13l6-24H176C176.62,92,177.26,92,177.89,92.05Zm33,44.68A35.94,35.94,0,0,1,176,164H144a20,20,0,0,0-19.4,15.15L116.39,212H93.13l18-72H144a59.89,59.89,0,0,0,56.1-38.75,36.12,36.12,0,0,1,10.82,35.48Z" }, null, -1), f = [
  ...
  setup(A) {
    const l = A, c = s("weight", "regular"), r = s("size", "1em"), d = s("color", "currentColor"), _ = s("mirrored", !1), a = h(() => l.weight ?? c), n = h(() => l.size ?? r), H = h(() => l.color ?? d), u = h(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", m({
      ...
      g(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", v, f)) : a.value === "duotone" ? (t(), e("g", L, x)) : a.value === "fill" ? (t(), e("g", C, z)) : a.value === "light" ? (t(), e("g", B, P)) : a.value === "regular" ? (t(), e("g", b, V)) : a.value === "thin" ? (t(), e("g", W, j)) : Z("", !0)
    ], 16, M));
  }
});
export {
