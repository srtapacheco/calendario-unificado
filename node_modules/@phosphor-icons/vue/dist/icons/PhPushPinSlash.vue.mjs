import { defineComponent as m, inject as s, computed as n, openBlock as t, createElementBlock as e, mergeProps as A, renderSlot as g, createCommentVNode as Z, createElementVNode as o } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, M = /* @__PURE__ */ o("path", { d: "M56.88,31.93A12,12,0,1,0,39.12,48.07L60,71A76,76,0,0,0,35.46,84.51a20,20,0,0,0-1.6,29.73l45.46,45.47-39.8,39.8a12,12,0,0,0,17,17l39.8-39.81,45.47,45.46A20,20,0,0,0,155.9,228c.47,0,.94,0,1.41-.05A20,20,0,0,0,171.87,220a97.47,97.47,0,0,0,9.54-15.46l17.72,19.49a12,12,0,1,0,17.76-16.14Zm98.49,169.88L54.08,100.52C62,95,70.31,92.12,78.91,91.83l84.51,93A62,62,0,0,1,155.37,201.81Zm82.78-95-39,39.11a12,12,0,1,1-17-16.95l36.19-36.3-55-55L130.59,70.5a12,12,0,0,1-17-16.94l35.57-35.69a20,20,0,0,1,28.3,0l60.69,60.68A20,20,0,0,1,238.15,106.83Z" }, null, -1), C = [
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), L = s("mirrored", !1), a = n(() => l.weight ?? d), i = n(() => l.size ?? _), u = n(() => l.color ?? h), p = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (c, D) => (t(), e("svg", A({
      ...
      g(c.$slots, "default"),
      a.value === "bold" ? (t(), e("g", y, C)) : a.value === "duotone" ? (t(), e("g", f, S)) : a.value === "fill" ? (t(), e("g", x, B)) : a.value === "light" ? (t(), e("g", P, b)) : a.value === "regular" ? (t(), e("g", E, W)) : a.value === "thin" ? (t(), e("g", $, q)) : Z("", !0)
    ], 16, v));
  }
});
export {
