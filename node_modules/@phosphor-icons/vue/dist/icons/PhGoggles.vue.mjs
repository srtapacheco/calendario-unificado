import { defineComponent as u, inject as s, computed as l, openBlock as t, createElementBlock as e, mergeProps as p, renderSlot as g, createCommentVNode as C, createElementVNode as o } from "vue";
const M = ["width", "height", "fill", "transform"], v = { key: 0 }, H = /* @__PURE__ */ o("path", { d: "M180,60H76A76.08,76.08,0,0,0,0,136v4a24,24,0,0,0,13.74,21.69c3.15,8.71,10.51,16.75,21.52,23.27,11.52,6.81,25.6,11,36.74,11a44.06,44.06,0,0,0,42.32-32h27.36A44.06,44.06,0,0,0,184,196c18.53,0,50.62-12.81,58.31-34.33A24,24,0,0,0,256,140v-4A76.08,76.08,0,0,0,180,60ZM76,84H180a52.07,52.07,0,0,1,51.13,42.6A65,65,0,0,0,220.74,119c-11.52-6.81-25.6-11-36.74-11a44.06,44.06,0,0,0-42.32,32H114.32A44.06,44.06,0,0,0,72,108c-13.4,0-33.9,6.71-47.13,18.56A52.08,52.08,0,0,1,76,84Zm-4,88c-14.13,0-36-12.15-36-20,0-2.74,3.55-7.61,11.48-12.3,9-5.32,18.8-7.7,24.52-7.7a20,20,0,0,1,0,40Zm136.52-7.7c-9,5.32-18.8,7.7-24.52,7.7a20,20,0,0,1,0-40c14.13,0,36,12.15,36,20C220,154.74,216.45,159.61,208.52,164.3Z" }, null, -1), y = [
  H
  ...
  setup(r) {
    const c = r, A = s("weight", "regular"), d = s("size", "1em"), h = s("color", "currentColor"), _ = s("mirrored", !1), a = l(() => c.weight ?? A), n = l(() => c.size ?? d), m = l(() => c.color ?? h), Z = l(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), e("svg", p({
      ...
      g(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", v, y)) : a.value === "duotone" ? (t(), e("g", f, S)) : a.value === "fill" ? (t(), e("g", k, z)) : a.value === "light" ? (t(), e("g", B, b)) : a.value === "regular" ? (t(), e("g", E, V)) : a.value === "thin" ? (t(), e("g", W, j)) : C("", !0)
    ], 16, M));
  }
});
export {
