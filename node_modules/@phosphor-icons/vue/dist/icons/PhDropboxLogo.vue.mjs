import { defineComponent as u, inject as s, computed as n, openBlock as l, createElementBlock as t, mergeProps as p, renderSlot as g, createCommentVNode as M, createElementVNode as o } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ o("path", { d: "M238.83,146.13,201.08,120l37.75-26.13a12,12,0,0,0,0-19.74l-52-36a12,12,0,0,0-13.66,0L128,69.41,82.83,38.13a12,12,0,0,0-13.66,0l-52,36a12,12,0,0,0,0,19.74L54.92,120,17.17,146.13a12,12,0,0,0,0,19.74l52,36a12,12,0,0,0,13.66,0L128,170.59l45.17,31.28a12,12,0,0,0,13.66,0l52-36a12,12,0,0,0,0-19.74ZM128,141.41,97.08,120,128,98.59,158.92,120ZM180,62.6,210.92,84,180,105.4,149.08,84Zm-104,0L106.92,84,76,105.4,45.08,84Zm0,114.8L45.08,156,76,134.6,106.92,156Zm104,0L149.08,156,180,134.6,210.92,156Zm-25.27,32.09a12,12,0,0,1-3,16.7l-16.86,11.68a12,12,0,0,1-13.66,0l-16.86-11.68A12,12,0,1,1,118,206.46l10,6.94,10-6.94A12,12,0,0,1,154.73,209.49Z" }, null, -1), w = [
  f
  ...
  setup(L) {
    const a = L, d = s("weight", "regular"), c = s("size", "1em"), m = s("color", "currentColor"), _ = s("mirrored", !1), e = n(() => a.weight ?? d), i = n(() => a.size ?? c), Z = n(() => a.color ?? m), h = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (r, F) => (l(), t("svg", p({
      ...
      g(r.$slots, "default"),
      e.value === "bold" ? (l(), t("g", y, w)) : e.value === "duotone" ? (l(), t("g", k, S)) : e.value === "fill" ? (l(), t("g", z, B)) : e.value === "light" ? (l(), t("g", b, E)) : e.value === "regular" ? (l(), t("g", P, W)) : e.value === "thin" ? (l(), t("g", $, D)) : M("", !0)
    ], 16, v));
  }
});
export {
