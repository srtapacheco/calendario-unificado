import { defineComponent as u, inject as s, computed as c, openBlock as t, createElementBlock as e, mergeProps as M, renderSlot as p, createCommentVNode as g, createElementVNode as o } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ o("path", { d: "M178,78A84,84,0,1,0,78,178,84,84,0,1,0,178,78Zm42,82a60.75,60.75,0,0,1-.38,6.65l-44-44a83.31,83.31,0,0,0,4-19.34A60.09,60.09,0,0,1,220,160Zm-119.84-4.16a60.07,60.07,0,0,1,55.68-55.68A60.07,60.07,0,0,1,100.16,155.84Zm52.51-79.5a83.31,83.31,0,0,0-19.34,4l-44-44A60.75,60.75,0,0,1,96,36,60.09,60.09,0,0,1,152.67,76.34ZM64.19,45.16l46.73,46.73a85,85,0,0,0-19,19L45.16,64.19A60.45,60.45,0,0,1,64.19,45.16ZM36,96a60.75,60.75,0,0,1,.38-6.65l44,44a83.31,83.31,0,0,0-4,19.34A60.09,60.09,0,0,1,36,96Zm67.33,83.66a83.31,83.31,0,0,0,19.34-4l44,44A60.75,60.75,0,0,1,160,220,60.09,60.09,0,0,1,103.33,179.66Zm88.48,31.18-46.73-46.73a85,85,0,0,0,19-19l46.73,46.73A60.45,60.45,0,0,1,191.81,210.84Z" }, null, -1), L = [
  f
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), Z = s("size", "1em"), _ = s("color", "currentColor"), h = s("mirrored", !1), a = c(() => l.weight ?? d), n = c(() => l.size ?? Z), A = c(() => l.color ?? _), m = c(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", M({
      ...
      p(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", y, L)) : a.value === "duotone" ? (t(), e("g", w, x)) : a.value === "fill" ? (t(), e("g", S, B)) : a.value === "light" ? (t(), e("g", E, b)) : a.value === "regular" ? (t(), e("g", H, V)) : a.value === "thin" ? (t(), e("g", W, j)) : g("", !0)
    ], 16, v));
  }
});
export {
