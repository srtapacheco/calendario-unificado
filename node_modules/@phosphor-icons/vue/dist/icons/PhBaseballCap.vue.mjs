import { defineComponent as v, inject as n, computed as i, openBlock as t, createElementBlock as e, mergeProps as Z, renderSlot as p, createCommentVNode as g, createElementVNode as o } from "vue";
const V = ["width", "height", "fill", "transform"], C = { key: 0 }, M = /* @__PURE__ */ o("path", { d: "M128,20A108.12,108.12,0,0,0,20,128v56a27.86,27.86,0,0,0,15.26,24.93,28,28,0,0,0,29.28-2.34C76.2,198.11,96.68,188,128,188s51.8,10.1,63.46,18.58A28,28,0,0,0,236,184V128A108.12,108.12,0,0,0,128,20Zm84,108v1.87a170,170,0,0,0-33.29-14.3,170.81,170.81,0,0,0-23.45-67A84.14,84.14,0,0,1,212,128Zm-58.46-18.12a174.42,174.42,0,0,0-51.08,0A150,150,0,0,1,128,50.94,150.07,150.07,0,0,1,153.54,109.88Zm-52.8-61.31a170.81,170.81,0,0,0-23.45,67A170,170,0,0,0,44,129.87V128A84.14,84.14,0,0,1,100.74,48.57Zm109.11,139a4,4,0,0,1-4.28-.36C191,176.61,165.77,164,128,164s-63,12.61-77.57,23.18a4,4,0,0,1-4.28.36A3.76,3.76,0,0,1,44,184V158.14a148,148,0,0,1,168,0V184A3.76,3.76,0,0,1,209.85,187.54Z" }, null, -1), y = [
  M
  ...
  setup(c) {
    const s = c, A = n("weight", "regular"), d = n("size", "1em"), _ = n("color", "currentColor"), h = n("mirrored", !1), a = i(() => s.weight ?? A), l = i(() => s.size ?? d), m = i(() => s.color ?? _), u = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (r, G) => (t(), e("svg", Z({
      ...
      p(r.$slots, "default"),
      a.value === "bold" ? (t(), e("g", C, y)) : a.value === "duotone" ? (t(), e("g", f, k)) : a.value === "fill" ? (t(), e("g", x, B)) : a.value === "light" ? (t(), e("g", b, E)) : a.value === "regular" ? (t(), e("g", P, $)) : a.value === "thin" ? (t(), e("g", j, D)) : g("", !0)
    ], 16, V));
  }
});
export {
