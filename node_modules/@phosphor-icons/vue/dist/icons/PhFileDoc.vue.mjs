...
const M = ["width", "height", "fill", "transform"], V = { key: 0 }, g = /* @__PURE__ */ e("path", { d: "M48,140H32a12,12,0,0,0-12,12v56a12,12,0,0,0,12,12H48a40,40,0,0,0,0-80Zm0,56H44V164h4a16,16,0,0,1,0,32Zm180.3-3.8a12,12,0,0,1,.37,17A34,34,0,0,1,204,220c-19.85,0-36-17.94-36-40s16.15-40,36-40a34,34,0,0,1,24.67,10.83,12,12,0,0,1-17.34,16.6A10.27,10.27,0,0,0,204,164c-6.5,0-12,7.33-12,16s5.5,16,12,16a10.27,10.27,0,0,0,7.33-3.43A12,12,0,0,1,228.3,192.2ZM128,140c-19.85,0-36,17.94-36,40s16.15,40,36,40,36-17.94,36-40S147.85,140,128,140Zm0,56c-6.5,0-12-7.33-12-16s5.5-16,12-16,12,7.33,12,16S134.5,196,128,196ZM48,120a12,12,0,0,0,12-12V44h76V92a12,12,0,0,0,12,12h48v4a12,12,0,0,0,24,0V88a12,12,0,0,0-3.51-8.48l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40v68A12,12,0,0,0,48,120ZM160,57l23,23H160Z" }, null, -1), S = [
  ...
  setup(h) {
    const s = h, r = c("weight", "regular"), d = c("size", "1em"), _ = c("color", "currentColor"), Z = c("mirrored", !1), o = l(() => s.weight ?? r), n = l(() => s.size ?? d), m = l(() => s.color ?? _), A = l(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), a("svg", v({
      ...
      u(i.$slots, "default"),
      o.value === "bold" ? (t(), a("g", V, S)) : o.value === "duotone" ? (t(), a("g", y, k)) : o.value === "fill" ? (t(), a("g", x, C)) : o.value === "light" ? (t(), a("g", B, b)) : o.value === "regular" ? (t(), a("g", E, W)) : o.value === "thin" ? (t(), a("g", $, D)) : p("", !0)
    ], 16, M));
  }
});
export {
