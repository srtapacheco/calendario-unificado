import { defineComponent as L, inject as s, computed as n, openBlock as l, createElementBlock as t, mergeProps as u, renderSlot as M, createCommentVNode as V, createElementVNode as e } from "vue";
const p = ["width", "height", "fill", "transform"], A = { key: 0 }, g = /* @__PURE__ */ e("path", { d: "M225.6,62.65l-88-48.18a19.91,19.91,0,0,0-19.2,0l-88,48.17A20,20,0,0,0,20,80.19v95.62a20,20,0,0,0,10.4,17.55l88,48.17a19.89,19.89,0,0,0,19.2,0l88-48.18A20,20,0,0,0,236,175.81V80.19A20,20,0,0,0,225.6,62.65ZM164,152v47.72l-24,13.14V135.11l72-39.42v22.92l-41.76,22.86A12,12,0,0,0,164,152ZM85.76,141.47,44,118.61V95.69l72,39.42v77.75L92,199.72V152A12,12,0,0,0,85.76,141.47ZM83.14,61.13l39.1,21.4a11.95,11.95,0,0,0,11.52,0l39.1-21.4L199,75.45l-71,38.87L57,75.45ZM128,36.57l19.87,10.88L128,58.33,108.13,47.45ZM44,146l24,13.14v27.47L44,173.44Zm144,40.61V159.11L212,146v27.47Z" }, null, -1), y = [
  g
  ...
  setup(v) {
    const a = v, d = s("weight", "regular"), c = s("size", "1em"), h = s("color", "currentColor"), _ = s("mirrored", !1), o = n(() => a.weight ?? d), i = n(() => a.size ?? c), Z = n(() => a.color ?? h), m = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (r, F) => (l(), t("svg", u({
      ...
      M(r.$slots, "default"),
      o.value === "bold" ? (l(), t("g", A, y)) : o.value === "duotone" ? (l(), t("g", f, x)) : o.value === "fill" ? (l(), t("g", C, z)) : o.value === "light" ? (l(), t("g", B, N)) : o.value === "regular" ? (l(), t("g", E, W)) : o.value === "thin" ? (l(), t("g", $, q)) : V("", !0)
    ], 16, p));
  }
});
export {
