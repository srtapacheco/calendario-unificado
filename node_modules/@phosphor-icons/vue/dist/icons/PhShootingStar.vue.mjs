...
const v = ["width", "height", "fill", "transform"], M = { key: 0 }, y = /* @__PURE__ */ t("path", { d: "M243.18,68.87A17.16,17.16,0,0,0,228.24,57l-34.83-3L179.83,22.41a17.24,17.24,0,0,0-31.66,0L134.6,54.07,99.76,57A17.13,17.13,0,0,0,90,87.11l26.3,22.46-7.87,33.36A17.2,17.2,0,0,0,134,161.56l30-17.82,30,17.82a17.19,17.19,0,0,0,25.58-18.63l-7.87-33.36L238,87.11A17.07,17.07,0,0,0,243.18,68.87ZM192.91,94A17.05,17.05,0,0,0,187.36,111l5.14,21.79-19.68-11.69a17.22,17.22,0,0,0-17.64,0L135.5,132.76,140.64,111A17,17,0,0,0,135.09,94l-17-14.49,22.54-1.9A17.17,17.17,0,0,0,155,67.3l9-20.91,9,20.9a17.18,17.18,0,0,0,14.38,10.36l22.54,1.9ZM32.49,184.49a12,12,0,0,1-17-17l52-52a12,12,0,1,1,17,17Zm68,4-52,52a12,12,0,0,1-17-17l52-52a12,12,0,0,1,17,17Zm72-17a12,12,0,0,1,0,17l-52,52a12,12,0,0,1-17-17l52-52A12,12,0,0,1,172.49,171.51Z" }, null, -1), f = [
  ...
  setup(d) {
    const o = d, c = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), m = s("mirrored", !1), e = n(() => o.weight ?? c), i = n(() => o.size ?? _), L = n(() => o.color ?? h), u = n(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (r, F) => (l(), a("svg", A({
      ...
      p(r.$slots, "default"),
      e.value === "bold" ? (l(), a("g", M, f)) : e.value === "duotone" ? (l(), a("g", w, x)) : e.value === "fill" ? (l(), a("g", z, B)) : e.value === "light" ? (l(), a("g", N, E)) : e.value === "regular" ? (l(), a("g", P, W)) : e.value === "thin" ? (l(), a("g", $, q)) : g("", !0)
    ], 16, v));
  }
});
export {
