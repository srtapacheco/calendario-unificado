...
const L = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ l("path", { d: "M240,124H223.83l19.29-47.48a12,12,0,0,0-22.24-9l-23,56.51H162.08l-23-56.51a12,12,0,0,0-22.24,0L93.92,124H58.08l-23-56.51a12,12,0,0,0-22.24,9L32.17,124H16a12,12,0,0,0,0,24H41.92l23,56.52a12,12,0,0,0,22.24,0l23-56.52h35.84l23,56.52a12,12,0,0,0,22.24,0l23-56.52H240a12,12,0,0,0,0-24ZM76,168.12,67.83,148H84.17ZM119.83,124,128,103.89,136.17,124ZM180,168.12,171.83,148h16.34Z" }, null, -1), f = [
  ...
  setup(h) {
    const a = h, c = s("weight", "regular"), d = s("size", "1em"), _ = s("color", "currentColor"), H = s("mirrored", !1), o = n(() => a.weight ?? c), i = n(() => a.size ?? d), u = n(() => a.color ?? _), p = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : H ? "scale(-1, 1)" : void 0);
    return (r, q) => (t(), e("svg", M({
      ...
      m(r.$slots, "default"),
      o.value === "bold" ? (t(), e("g", v, f)) : o.value === "duotone" ? (t(), e("g", w, C)) : o.value === "fill" ? (t(), e("g", S, B)) : o.value === "light" ? (t(), e("g", N, A)) : o.value === "regular" ? (t(), e("g", E, V)) : o.value === "thin" ? (t(), e("g", W, j)) : g("", !0)
    ], 16, L));
  }
});
export {
