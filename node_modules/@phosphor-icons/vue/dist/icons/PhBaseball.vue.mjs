import { defineComponent as u, inject as s, computed as n, openBlock as a, createElementBlock as t, mergeProps as p, renderSlot as g, createCommentVNode as v, createElementVNode as e } from "vue";
const y = ["width", "height", "fill", "transform"], M = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20ZM77,194.66A108.9,108.9,0,0,0,85.54,182a12,12,0,1,0-20.77-12A83.28,83.28,0,0,1,60,177.27a83.73,83.73,0,0,1,0-98.54A83.28,83.28,0,0,1,64.77,86,12,12,0,1,0,85.54,74,108.9,108.9,0,0,0,77,61.34a83.76,83.76,0,0,1,102.06,0A108.9,108.9,0,0,0,170.46,74a12,12,0,1,0,20.77,12A83.28,83.28,0,0,1,196,78.73a83.73,83.73,0,0,1,0,98.54,83.28,83.28,0,0,1-4.74-7.28,12,12,0,1,0-20.77,12A108.9,108.9,0,0,0,179,194.66a83.76,83.76,0,0,1-102.06,0Zm22.2-80.14A110,110,0,0,1,100,128a110,110,0,0,1-.83,13.48A12,12,0,0,1,87.27,152a12.83,12.83,0,0,1-1.5-.09,12,12,0,0,1-10.42-13.39A85.75,85.75,0,0,0,76,128a85.75,85.75,0,0,0-.65-10.52,12,12,0,1,1,23.82-3Zm71.06,37.39a12.83,12.83,0,0,1-1.5.09,12,12,0,0,1-11.9-10.52,109.88,109.88,0,0,1,0-27,12,12,0,1,1,23.82,3,85.46,85.46,0,0,0,0,21A12,12,0,0,1,170.23,151.91Z" }, null, -1), w = [
  f
  ...
  setup(r) {
    const c = r, d = s("weight", "regular"), A = s("size", "1em"), _ = s("color", "currentColor"), h = s("mirrored", !1), o = n(() => c.weight ?? d), l = n(() => c.size ?? A), m = n(() => c.color ?? _), Z = n(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (i, F) => (a(), t("svg", p({
      ...
      g(i.$slots, "default"),
      o.value === "bold" ? (a(), t("g", M, w)) : o.value === "duotone" ? (a(), t("g", k, z)) : o.value === "fill" ? (a(), t("g", B, L)) : o.value === "light" ? (a(), t("g", b, E)) : o.value === "regular" ? (a(), t("g", P, W)) : o.value === "thin" ? (a(), t("g", $, q)) : v("", !0)
    ], 16, y));
  }
});
export {
