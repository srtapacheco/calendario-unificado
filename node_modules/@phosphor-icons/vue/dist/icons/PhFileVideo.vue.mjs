...
const M = ["width", "height", "fill", "transform"], m = { key: 0 }, g = /* @__PURE__ */ a("path", { d: "M150.35,149.82a12,12,0,0,0-11.63-.6L118,159.37A20,20,0,0,0,100,148H48a20,20,0,0,0-20,20v40a20,20,0,0,0,20,20h52a20,20,0,0,0,18.3-12l20.12,10.58A12,12,0,0,0,156,216V160A12,12,0,0,0,150.35,149.82ZM96,204H52V172H96Zm36-7.87-12-6.3v-4.72l12-5.87ZM216.49,79.51l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40v76a12,12,0,0,0,24,0V44h76V92a12,12,0,0,0,12,12h48V212h-8a12,12,0,0,0,0,24h12a20,20,0,0,0,20-20V88A12,12,0,0,0,216.49,79.51ZM160,57l23,23H160Z" }, null, -1), y = [
  ...
  setup(r) {
    const l = r, c = s("weight", "regular"), d = s("size", "1em"), V = s("color", "currentColor"), _ = s("mirrored", !1), o = h(() => l.weight ?? c), n = h(() => l.size ?? d), A = h(() => l.color ?? V), v = h(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), e("svg", u({
      ...
      H(i.$slots, "default"),
      o.value === "bold" ? (t(), e("g", m, y)) : o.value === "duotone" ? (t(), e("g", f, x)) : o.value === "fill" ? (t(), e("g", S, C)) : o.value === "light" ? (t(), e("g", B, b)) : o.value === "regular" ? (t(), e("g", E, P)) : o.value === "thin" ? (t(), e("g", W, j)) : p("", !0)
    ], 16, M));
  }
});
export {
