...
const m = ["width", "height", "fill", "transform"], g = { key: 0 }, V = /* @__PURE__ */ e("path", { d: "M187.38,212.21a12,12,0,1,1-22.76,7.58l-8-24a12,12,0,1,1,22.76-7.58ZM128,184a12,12,0,0,0-12,12v28a12,12,0,0,0,24,0V196A12,12,0,0,0,128,184Zm-36.21-3.38a12,12,0,0,0-15.17,7.59l-8,24a12,12,0,1,0,22.76,7.58l8-24A12,12,0,0,0,91.79,180.62ZM252,112c0,17.92-14.23,33.89-40.08,45-22.61,9.69-52.42,15-83.92,15s-61.31-5.34-83.92-15C18.23,145.89,4,129.92,4,112,4,87.94,29.28,68,71.91,58.11A67.61,67.61,0,0,1,175.77,47.6a69.05,69.05,0,0,1,8.79,10.62C226.9,68.14,252,88.05,252,112ZM84,96.83v3a4,4,0,0,0,3,3.87A184.32,184.32,0,0,0,128,108a184.32,184.32,0,0,0,41-4.27,4,4,0,0,0,3-3.87V96a44,44,0,0,0-44-44h-.59C103.47,52.31,84,72.43,84,96.83ZM228,112c0-6.64-7.65-12.76-12.21-15.83a91.73,91.73,0,0,0-20.48-9.88A69.47,69.47,0,0,1,196,96v3.93a27.84,27.84,0,0,1-21.66,27.19A207.92,207.92,0,0,1,128,132a207.92,207.92,0,0,1-46.33-4.88A27.84,27.84,0,0,1,60,99.94h0V96.87a70.37,70.37,0,0,1,.82-10.63,92.39,92.39,0,0,0-20.53,9.88C35.7,99.19,28,105.34,28,112c0,14.68,39,36,100,36S228,126.68,228,112Z" }, null, -1), y = [
  ...
  setup(r) {
    const s = r, d = l("weight", "regular"), h = l("size", "1em"), A = l("color", "currentColor"), _ = l("mirrored", !1), o = c(() => s.weight ?? d), n = c(() => s.size ?? h), Z = c(() => s.color ?? A), C = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, G) => (a(), t("svg", M({
      ...
      u(i.$slots, "default"),
      o.value === "bold" ? (a(), t("g", g, y)) : o.value === "duotone" ? (a(), t("g", S, k)) : o.value === "fill" ? (a(), t("g", x, B)) : o.value === "light" ? (a(), t("g", N, E)) : o.value === "regular" ? (a(), t("g", P, $)) : o.value === "thin" ? (a(), t("g", j, q)) : p("", !0)
    ], 16, m));
  }
});
export {
