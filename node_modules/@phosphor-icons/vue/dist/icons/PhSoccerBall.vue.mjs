...
const g = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm76,72.25L182,99.4,140,69.78V44.87A84.23,84.23,0,0,1,204,92.25ZM104.5,160,90.21,117.33,128,90.68l37.79,26.65L151.5,160ZM116,44.87V69.78L74,99.4,52,92.25A84.23,84.23,0,0,1,116,44.87ZM44,128a84.26,84.26,0,0,1,1-12.79l21.57,7,16,47.74L69.36,188.06A83.72,83.72,0,0,1,44,128Zm44.73,74.23L102,184h52l13.25,18.23a83.81,83.81,0,0,1-78.54,0Zm97.91-14.17L173.48,170l16-47.74,21.57-7a84,84,0,0,1-24.39,72.85Z" }, null, -1), V = [
  ...
  setup(i) {
    const s = i, r = a("weight", "regular"), h = a("size", "1em"), d = a("color", "currentColor"), m = a("mirrored", !1), o = Z(() => s.weight ?? r), n = Z(() => s.size ?? h), _ = Z(() => s.color ?? d), A = Z(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (c, D) => (t(), l("svg", M({
      ...
      u(c.$slots, "default"),
      o.value === "bold" ? (t(), l("g", v, V)) : o.value === "duotone" ? (t(), l("g", H, k)) : o.value === "fill" ? (t(), l("g", S, C)) : o.value === "light" ? (t(), l("g", z, N)) : o.value === "regular" ? (t(), l("g", b, P)) : o.value === "thin" ? (t(), l("g", W, j)) : p("", !0)
    ], 16, g));
  }
});
export {
