...
const A = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ t("path", { d: "M137,168l11.52-11.51a12,12,0,0,0-17-17L120,151l-15-15,11.52-11.51a12,12,0,0,0-17-17L88,119,72.49,103.51a12,12,0,0,0-17,17L59,124,38.54,144.49a36,36,0,0,0,0,50.91l2.55,2.54L15.51,223.51a12,12,0,0,0,17,17l25.57-25.58,2.54,2.55a36.06,36.06,0,0,0,50.91,0L132,197l3.51,3.52a12,12,0,0,0,17-17ZM94.54,200.49a12,12,0,0,1-17,0L55.51,178.43a12,12,0,0,1,0-17L76,141l39,39Zm146-185a12,12,0,0,0-17,0L197.94,41.09l-2.54-2.55a36.05,36.05,0,0,0-50.91,0L124,59l-3.51-3.52a12,12,0,0,0-17,17l80,80a12,12,0,0,0,17-17L197,132l20.49-20.49a36,36,0,0,0,0-50.91l-2.55-2.54,25.58-25.57A12,12,0,0,0,240.49,15.51Zm-40,79L180,115,141,76l20.49-20.49a12,12,0,0,1,17,0l22.06,22.06a12,12,0,0,1,0,17Z" }, null, -1), M = [
  ...
  setup(r) {
    const o = r, d = s("weight", "regular"), c = s("size", "1em"), _ = s("color", "currentColor"), h = s("mirrored", !1), e = n(() => o.weight ?? d), L = n(() => o.size ?? c), m = n(() => o.color ?? _), u = n(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (i, F) => (l(), a("svg", g({
      ...
      Z(i.$slots, "default"),
      e.value === "bold" ? (l(), a("g", y, M)) : e.value === "duotone" ? (l(), a("g", w, S)) : e.value === "fill" ? (l(), a("g", z, B)) : e.value === "light" ? (l(), a("g", N, b)) : e.value === "regular" ? (l(), a("g", E, W)) : e.value === "thin" ? (l(), a("g", $, q)) : v("", !0)
    ], 16, A));
  }
});
export {
