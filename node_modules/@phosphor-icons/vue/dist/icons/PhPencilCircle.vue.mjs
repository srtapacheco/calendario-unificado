...
const M = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ o("path", { d: "M204.37,51.6A108.08,108.08,0,1,0,236,128,108.09,108.09,0,0,0,204.37,51.6ZM92,200a12,12,0,1,1,24,0v11.11a83.78,83.78,0,0,1-24-7.22Zm48,0a12,12,0,1,1,24,0v3.89a83.78,83.78,0,0,1-24,7.22Zm-33.86-52h43.72l7.57,16.42A35.95,35.95,0,0,0,128,173.22a35.95,35.95,0,0,0-29.43-8.79Zm11.08-24L128,100.62,138.78,124ZM188,186.79V176a12.15,12.15,0,0,0-1.1-5l-48-104a12,12,0,0,0-21.8,0L69.1,171a12.15,12.15,0,0,0-1.1,5v10.77a84,84,0,1,1,120,0Z" }, null, -1), w = [
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), h = s("size", "1em"), _ = s("color", "currentColor"), m = s("mirrored", !1), a = n(() => l.weight ?? d), i = n(() => l.size ?? h), Z = n(() => l.color ?? _), v = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (c, D) => (t(), e("svg", p({
      ...
      g(c.$slots, "default"),
      a.value === "bold" ? (t(), e("g", y, w)) : a.value === "duotone" ? (t(), e("g", V, x)) : a.value === "fill" ? (t(), e("g", C, z)) : a.value === "light" ? (t(), e("g", B, P)) : a.value === "regular" ? (t(), e("g", b, W)) : a.value === "thin" ? (t(), e("g", $, H)) : A("", !0)
    ], 16, M));
  }
});
export {
