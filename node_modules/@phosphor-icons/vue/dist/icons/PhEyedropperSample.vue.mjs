...
const M = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ t("path", { d: "M228,67.24a39.77,39.77,0,0,0-12.51-28.52C199.91,24,174.71,24.5,159.29,39.93L142.48,56.84a28,28,0,0,0-35.64,3.29l-9,9a20,20,0,0,0-.73,27.49L48.9,144.84A43.76,43.76,0,0,0,37,185.28l-7.5,17.19a17.66,17.66,0,0,0,3.71,19.65,19.9,19.9,0,0,0,22.15,4.19l16.31-7.13a43.89,43.89,0,0,0,39.45-12.09l48.24-48.26a20,20,0,0,0,27.47-.73l9-9a28.06,28.06,0,0,0,3.25-35.71l17.24-17.34A39.69,39.69,0,0,0,228,67.24ZM142.35,141.9,136.29,148H79.73l34.34-34.36Zm-48.2,48.21a20,20,0,0,1-20,5,11.93,11.93,0,0,0-8.32.47L57,199.38,60.69,191a12,12,0,0,0,.37-8.64A20,20,0,0,1,60.41,172h51.88Zm105.14-111-25.37,25.52a12,12,0,0,0,0,17l4.88,4.88a4,4,0,0,1,0,5.66l-6.14,6.15-4.88-4.89h0L122.55,88.14h0l-4.88-4.89,6.14-6.14a4,4,0,0,1,5.66,0L134.35,82a12,12,0,0,0,8.49,3.51h0A12,12,0,0,0,151.34,82l24.94-25.08c6.3-6.3,16.48-6.63,22.71-.74a16,16,0,0,1,.3,23Z" }, null, -1), f = [
  ...
  setup(r) {
    const o = r, h = s("weight", "regular"), d = s("size", "1em"), _ = s("color", "currentColor"), p = s("mirrored", !1), e = n(() => o.weight ?? h), c = n(() => o.size ?? d), m = n(() => o.color ?? _), u = n(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (i, D) => (l(), a("svg", Z({
      ...
      g(i.$slots, "default"),
      e.value === "bold" ? (l(), a("g", v, f)) : e.value === "duotone" ? (l(), a("g", w, C)) : e.value === "fill" ? (l(), a("g", S, z)) : e.value === "light" ? (l(), a("g", B, N)) : e.value === "regular" ? (l(), a("g", b, V)) : e.value === "thin" ? (l(), a("g", W, j)) : A("", !0)
    ], 16, M));
  }
});
export {
