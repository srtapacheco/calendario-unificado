import { defineComponent as u, inject as s, computed as n, openBlock as e, createElementBlock as o, mergeProps as M, renderSlot as p, createCommentVNode as g, createElementVNode as t } from "vue";
const A = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ t("path", { d: "M190.23,128l24.88-24.89a44,44,0,1,0-62.22-62.22L128,65.77,103.11,40.89a44,44,0,1,0-62.22,62.22L65.77,128,40.89,152.89a44,44,0,1,0,62.22,62.22L128,190.23l24.89,24.88a44,44,0,1,0,62.22-62.22ZM169.86,57.86h0a20,20,0,1,1,28.28,28.28L173.25,111,145,82.75ZM156.28,128,128,156.28,99.72,128,128,99.72ZM57.86,86.14A20,20,0,1,1,86.14,57.86L111,82.75,82.75,111Zm28.28,112a20,20,0,1,1-28.28-28.28L82.75,145,111,173.25Zm112,0a20,20,0,0,1-28.28,0L145,173.25,173.25,145l24.89,24.89a20,20,0,0,1,0,28.28Z" }, null, -1), f = [
  ...
  setup(c) {
    const a = c, d = s("weight", "regular"), h = s("size", "1em"), _ = s("color", "currentColor"), Z = s("mirrored", !1), l = n(() => a.weight ?? d), i = n(() => a.size ?? h), L = n(() => a.color ?? _), m = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (r, G) => (e(), o("svg", M({
      ...
      p(r.$slots, "default"),
      l.value === "bold" ? (e(), o("g", v, f)) : l.value === "duotone" ? (e(), o("g", w, S)) : l.value === "fill" ? (e(), o("g", z, N)) : l.value === "light" ? (e(), o("g", b, P)) : l.value === "regular" ? (e(), o("g", V, $)) : l.value === "thin" ? (e(), o("g", j, D)) : g("", !0)
    ], 16, A));
  }
});
export {
