...
const L = ["width", "height", "fill", "transform"], M = { key: 0 }, Z = /* @__PURE__ */ e("path", { d: "M192,104H164V56a20,20,0,0,0-20-20H32A12,12,0,0,0,20.8,52.3c10.88,28.39,8.3,78.36-.33,108.38A12,12,0,0,0,20,164v36a20,20,0,0,0,20,20H66.11a20.16,20.16,0,0,0,9-2.11L86.83,212h14.34l11.77,5.89a20.16,20.16,0,0,0,9,2.11h28.22a20.16,20.16,0,0,0,8.95-2.11L170.83,212h14.34l11.77,5.89a20.16,20.16,0,0,0,8.95,2.11H232a20,20,0,0,0,20-20V164A60.07,60.07,0,0,0,192,104ZM48,60h92v44H116a12,12,0,0,0,0,24h76a36.07,36.07,0,0,1,33.94,24H47.21C52.75,124.08,54.23,88.41,48,60ZM228,196H206.83l-11.77-5.89a20.16,20.16,0,0,0-8.95-2.11H169.89a20.16,20.16,0,0,0-8.95,2.11L149.17,196H122.83l-11.77-5.89a20.16,20.16,0,0,0-9-2.11H85.89a20.16,20.16,0,0,0-9,2.11L65.17,196H44V176H228Z" }, null, -1), y = [
  ...
  setup(i) {
    const l = i, c = H("weight", "regular"), r = H("size", "1em"), d = H("color", "currentColor"), _ = H("mirrored", !1), o = s(() => l.weight ?? c), h = s(() => l.size ?? r), u = s(() => l.color ?? d), v = s(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (n, D) => (a(), t("svg", V({
      ...
      g(n.$slots, "default"),
      o.value === "bold" ? (a(), t("g", M, y)) : o.value === "duotone" ? (a(), t("g", A, C)) : o.value === "fill" ? (a(), t("g", k, S)) : o.value === "light" ? (a(), t("g", z, N)) : o.value === "regular" ? (a(), t("g", b, P)) : o.value === "thin" ? (a(), t("g", W, j)) : m("", !0)
    ], 16, L));
  }
});
export {
