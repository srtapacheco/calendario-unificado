import { defineComponent as u, inject as L, computed as s, openBlock as a, createElementBlock as l, mergeProps as p, renderSlot as M, createCommentVNode as A, createElementVNode as t } from "vue";
const g = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ t("path", { d: "M114,102.18a19.87,19.87,0,0,0,28.08,0L170.19,74a19.86,19.86,0,0,0,0-28.07L142,17.8a19.89,19.89,0,0,0-28.08,0L85.81,46a19.86,19.86,0,0,0,0,28.07Zm14-64.47L150.28,60,128,82.28,105.72,60ZM238.19,114,210,85.81a19.88,19.88,0,0,0-28.08,0L153.81,114a19.87,19.87,0,0,0,0,28.08L182,170.19h0a19.89,19.89,0,0,0,28.08,0L238.19,142a19.87,19.87,0,0,0,0-28.08ZM196,150.28,173.72,128,196,105.72,218.28,128ZM108,128a19.73,19.73,0,0,0-5.81-14L74,85.81a19.88,19.88,0,0,0-28.08,0L17.81,114a19.87,19.87,0,0,0,0,28.08L46,170.19h0a19.89,19.89,0,0,0,28.08,0L102.19,142A19.73,19.73,0,0,0,108,128ZM60,150.28,37.72,128,60,105.72,82.28,128Zm82,3.53a19.89,19.89,0,0,0-28.08,0L85.81,182a19.86,19.86,0,0,0,0,28.07L114,238.2h0a19.89,19.89,0,0,0,28.08,0L170.19,210a19.86,19.86,0,0,0,0-28.07Zm-14,64.48L105.72,196,128,173.72,150.28,196Z" }, null, -1), f = [
  ...
  setup(i) {
    const o = i, r = L("weight", "regular"), d = L("size", "1em"), c = L("color", "currentColor"), Z = L("mirrored", !1), e = s(() => o.weight ?? r), h = s(() => o.size ?? d), _ = s(() => o.color ?? c), m = s(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (n, q) => (a(), l("svg", p({
      ...
      M(n.$slots, "default"),
      e.value === "bold" ? (a(), l("g", v, f)) : e.value === "duotone" ? (a(), l("g", w, S)) : e.value === "fill" ? (a(), l("g", z, B)) : e.value === "light" ? (a(), l("g", N, E)) : e.value === "regular" ? (a(), l("g", P, W)) : e.value === "thin" ? (a(), l("g", $, D)) : A("", !0)
    ], 16, g));
  }
});
export {
