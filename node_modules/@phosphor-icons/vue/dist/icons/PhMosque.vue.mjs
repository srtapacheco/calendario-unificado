...
const C = ["width", "height", "fill", "transform"], g = { key: 0 }, M = /* @__PURE__ */ e("path", { d: "M220,124a32,32,0,0,0-8.06,1c-1.29-41.54-29.35-62.32-50-77.58C150.18,38.73,140,31.21,140,24a12,12,0,0,0-24,0c0,7.21-10.18,14.73-22,23.45-20.63,15.26-48.69,36-50,77.58A32,32,0,0,0,4,156v52a12,12,0,0,0,12,12H240a12,12,0,0,0,12-12V156A32,32,0,0,0,220,124ZM44,196H28V156a8,8,0,0,1,16,0ZM108.31,66.74c7-5.14,14-10.36,19.69-16.27,5.68,5.91,12.74,11.13,19.69,16.27C164.8,79.4,182.4,92.44,186.9,116H69.1C73.6,92.44,91.2,79.4,108.31,66.74ZM188,196H164V168a12,12,0,0,0-24,0v28H116V168a12,12,0,0,0-24,0v28H68V140H188Zm40,0H212V156a8,8,0,0,1,16,0Z" }, null, -1), y = [
  ...
  setup(r) {
    const s = r, h = c("weight", "regular"), v = c("size", "1em"), d = c("color", "currentColor"), V = c("mirrored", !1), o = n(() => s.weight ?? h), i = n(() => s.size ?? v), _ = n(() => s.color ?? d), H = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : V ? "scale(-1, 1)" : void 0);
    return (l, F) => (a(), t("svg", m({
      ...
      Z(l.$slots, "default"),
      o.value === "bold" ? (a(), t("g", g, y)) : o.value === "duotone" ? (a(), t("g", A, k)) : o.value === "fill" ? (a(), t("g", x, z)) : o.value === "light" ? (a(), t("g", B, b)) : o.value === "regular" ? (a(), t("g", E, W)) : o.value === "thin" ? (a(), t("g", $, q)) : p("", !0)
    ], 16, C));
  }
});
export {
