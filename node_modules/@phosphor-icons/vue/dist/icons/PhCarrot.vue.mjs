...
const V = ["width", "height", "fill", "transform"], C = { key: 0 }, f = /* @__PURE__ */ o("path", { d: "M232,60H213l19.51-19.51a12,12,0,1,0-17-17L196,43V24a12,12,0,0,0-24,0V50A68,68,0,0,0,96,63.87l0,0h0l0,0C55.45,103.68,25.18,197,21.78,207.77A20,20,0,0,0,40,236a20.12,20.12,0,0,0,8.24-1.78c7.64-2.42,56.79-18.34,98.91-41.82l.54-.3c17.1-9.57,33-20.39,44.44-32A68,68,0,0,0,206,84h26a12,12,0,0,0,0-24Zm-56.89,83.12-.09.09c-8.11,8.28-19.11,16.2-31.33,23.52l-23.21-23.21a12,12,0,1,0-17,17l18.22,18.22c-30.29,15.17-62.13,26.42-75.26,30.82,6.77-20.22,29.79-84.8,58.34-119.74l30.7,30.7a12,12,0,1,0,17-17L122.54,73.58a44,44,0,0,1,52.57,69.54Z" }, null, -1), Z = [
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), h = s("size", "1em"), _ = s("color", "currentColor"), u = s("mirrored", !1), a = c(() => l.weight ?? d), n = c(() => l.size ?? h), p = c(() => l.color ?? _), m = c(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", v({
      ...
      y(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", C, Z)) : a.value === "duotone" ? (t(), e("g", L, M)) : a.value === "fill" ? (t(), e("g", k, x)) : a.value === "light" ? (t(), e("g", z, N)) : a.value === "regular" ? (t(), e("g", b, P)) : a.value === "thin" ? (t(), e("g", W, j)) : A("", !0)
    ], 16, V));
  }
});
export {
