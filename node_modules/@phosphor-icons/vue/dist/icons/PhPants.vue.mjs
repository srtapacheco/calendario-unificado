...
const g = ["width", "height", "fill", "transform"], L = { key: 0 }, v = /* @__PURE__ */ o("path", { d: "M227.85,213.52l-22-176A20,20,0,0,0,186,20H70A20,20,0,0,0,50.15,37.52l-22,176A20,20,0,0,0,48,236H88.69A19.94,19.94,0,0,0,108.07,221l19.93-77,19.91,76.94A20,20,0,0,0,167.31,236H208a20,20,0,0,0,19.85-22.48ZM190,104.23A28.05,28.05,0,0,1,176.29,84h11.18ZM182.47,44l2,16H71.53l2-16ZM68.53,84H79.71A28,28,0,0,1,66,104.22ZM85.6,212H52.53l10.14-81.11A52.1,52.1,0,0,0,103.83,84H116V94.47Zm84.81,0L140,94.47V84h12.17a52.09,52.09,0,0,0,41.16,46.88L203.47,212Z" }, null, -1), y = [
  ...
  setup(r) {
    const a = r, c = s("weight", "regular"), d = s("size", "1em"), A = s("color", "currentColor"), H = s("mirrored", !1), l = n(() => a.weight ?? c), i = n(() => a.size ?? d), _ = n(() => a.color ?? A), Z = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : H ? "scale(-1, 1)" : void 0);
    return (h, D) => (t(), e("svg", u({
      ...
      p(h.$slots, "default"),
      l.value === "bold" ? (t(), e("g", L, y)) : l.value === "duotone" ? (t(), e("g", V, k)) : l.value === "fill" ? (t(), e("g", x, z)) : l.value === "light" ? (t(), e("g", C, N)) : l.value === "regular" ? (t(), e("g", P, E)) : l.value === "thin" ? (t(), e("g", W, j)) : m("", !0)
    ], 16, g));
  }
});
export {
