...
const p = ["width", "height", "fill", "transform"], M = { key: 0 }, g = /* @__PURE__ */ e("path", { d: "M236,104a36,36,0,0,0-48-33.94V56a36,36,0,0,0-60-26.8A36,36,0,0,0,70.06,68H56a36,36,0,0,0-26.8,60A36,36,0,0,0,68,185.94V200a36,36,0,0,0,60,26.8A36,36,0,0,0,185.94,188H200a36,36,0,0,0,26.8-60A35.82,35.82,0,0,0,236,104ZM200,92a12,12,0,0,1,0,24H188V104A12,12,0,0,1,200,92ZM152,44a12,12,0,0,1,12,12v48a12,12,0,0,1-12,12H140V56A12,12,0,0,1,152,44ZM92,56a12,12,0,0,1,24,0V68H104A12,12,0,0,1,92,56ZM56,92h48a12,12,0,0,1,12,12v12H56a12,12,0,0,1,0-24Zm0,72a12,12,0,0,1,0-24H68v12A12,12,0,0,1,56,164Zm48,48a12,12,0,0,1-12-12V152a12,12,0,0,1,12-12h12v60A12,12,0,0,1,104,212Zm60-12a12,12,0,0,1-24,0V188h12A12,12,0,0,1,164,200Zm36-36H152a12,12,0,0,1-12-12V140h60a12,12,0,0,1,0,24Z" }, null, -1), y = [
  ...
  setup(r) {
    const h = r, c = s("weight", "regular"), d = s("size", "1em"), Z = s("color", "currentColor"), A = s("mirrored", !1), o = n(() => h.weight ?? c), i = n(() => h.size ?? d), m = n(() => h.color ?? Z), H = n(() => h.mirrored !== void 0 ? h.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (l, D) => (a(), t("svg", V({
      ...
      v(l.$slots, "default"),
      o.value === "bold" ? (a(), t("g", M, y)) : o.value === "duotone" ? (a(), t("g", f, S)) : o.value === "fill" ? (a(), t("g", x, C)) : o.value === "light" ? (a(), t("g", B, b)) : o.value === "regular" ? (a(), t("g", E, W)) : o.value === "thin" ? (a(), t("g", $, L)) : u("", !0)
    ], 16, p));
  }
});
export {
