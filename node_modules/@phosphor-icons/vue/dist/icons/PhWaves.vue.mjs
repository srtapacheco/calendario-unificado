...
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, M = /* @__PURE__ */ o("path", { d: "M28,72a12,12,0,0,1,3.51-8.49A61.26,61.26,0,0,1,46.63,53.27,92.82,92.82,0,0,1,88,44c19.63,0,34,9.57,46.66,18,11.25,7.5,21,14,33.34,14,26.1,0,39.08-12.07,39.62-12.58A11.61,11.61,0,0,1,216,60a12,12,0,0,1,8.49,20.49,61.26,61.26,0,0,1-15.12,10.24A92.82,92.82,0,0,1,168,100c-19.63,0-34-9.57-46.66-18-11.25-7.5-21-14-33.34-14C61.9,68,49,80,48.49,80.49A12,12,0,0,1,28,72ZM216,172a11.61,11.61,0,0,0-8.38,3.42C207.08,175.93,194.1,188,168,188c-12.37,0-22.09-6.48-33.34-14-12.67-8.45-27-18-46.66-18a92.82,92.82,0,0,0-41.37,9.27,61.26,61.26,0,0,0-15.12,10.24,12,12,0,0,0,17,17C49,192,61.9,180,88,180c12.37,0,22.09,6.48,33.34,14,12.67,8.45,27,18,46.66,18a92.82,92.82,0,0,0,41.37-9.27,61.26,61.26,0,0,0,15.12-10.24A12,12,0,0,0,216,172Zm0-56a11.61,11.61,0,0,0-8.38,3.42C207.08,119.93,194.1,132,168,132c-12.37,0-22.09-6.48-33.34-14-12.67-8.45-27-18-46.66-18a92.82,92.82,0,0,0-41.37,9.27,61.26,61.26,0,0,0-15.12,10.24,12,12,0,0,0,17,17C49,136,61.9,124,88,124c12.37,0,22.09,6.48,33.34,14,12.67,8.45,27,18,46.66,18a92.82,92.82,0,0,0,41.37-9.27,61.26,61.26,0,0,0,15.12-10.24A12,12,0,0,0,216,116Z" }, null, -1), f = [
  ...
  setup(r) {
    const a = r, d = s("weight", "regular"), C = s("size", "1em"), _ = s("color", "currentColor"), h = s("mirrored", !1), c = n(() => a.weight ?? d), i = n(() => a.size ?? C), u = n(() => a.color ?? _), m = n(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (l, F) => (t(), e("svg", A({
      ...
      g(l.$slots, "default"),
      c.value === "bold" ? (t(), e("g", y, f)) : c.value === "duotone" ? (t(), e("g", w, x)) : c.value === "fill" ? (t(), e("g", V, B)) : c.value === "light" ? (t(), e("g", N, b)) : c.value === "regular" ? (t(), e("g", E, P)) : c.value === "thin" ? (t(), e("g", $, q)) : Z("", !0)
    ], 16, v));
  }
});
export {
