...
const M = ["width", "height", "fill", "transform"], g = { key: 0 }, H = /* @__PURE__ */ e("path", { d: "M200,76H188V64a36,36,0,0,0-60-26.8A36,36,0,0,0,69.27,54.54,36,36,0,0,0,20,88v40a108,108,0,0,0,216,0V112A36,36,0,0,0,200,76ZM140,64a12,12,0,0,1,24,0V76H140ZM92,64a12,12,0,0,1,24,0v40a12,12,0,0,1-24,0ZM44,88a12,12,0,0,1,24,0v16a12,12,0,0,1-24,0Zm168,40A84,84,0,0,1,44.61,138.15,35.93,35.93,0,0,0,80,130.8a35.89,35.89,0,0,0,43.65,3.34A36.23,36.23,0,0,0,130,140.5,51.82,51.82,0,0,0,116,176a12,12,0,0,0,24,0,28,28,0,0,1,28-28,12,12,0,0,0,0-24H152a12,12,0,0,1-12-12V100h60a12,12,0,0,1,12,12Z" }, null, -1), y = [
  ...
  setup(c) {
    const s = c, d = n("weight", "regular"), h = n("size", "1em"), _ = n("color", "currentColor"), v = n("mirrored", !1), o = i(() => s.weight ?? d), l = i(() => s.size ?? h), A = i(() => s.color ?? _), V = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : v ? "scale(-1, 1)" : void 0);
    return (r, D) => (a(), t("svg", Z({
      ...
      p(r.$slots, "default"),
      o.value === "bold" ? (a(), t("g", g, y)) : o.value === "duotone" ? (a(), t("g", f, C)) : o.value === "fill" ? (a(), t("g", x, z)) : o.value === "light" ? (a(), t("g", B, b)) : o.value === "regular" ? (a(), t("g", E, W)) : o.value === "thin" ? (a(), t("g", $, F)) : m("", !0)
    ], 16, M));
  }
});
export {
