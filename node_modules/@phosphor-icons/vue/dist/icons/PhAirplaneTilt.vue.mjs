import { defineComponent as p, inject as s, computed as n, openBlock as l, createElementBlock as a, mergeProps as m, renderSlot as g, createCommentVNode as v, createElementVNode as t } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, H = /* @__PURE__ */ t("path", { d: "M190,115.31,217.21,89.7l.26-.26a36,36,0,0,0-50.91-50.91c-.09.08-.17.17-.26.26L140.69,66,60.1,36.71A12,12,0,0,0,47.52,39.5l-24,24A12,12,0,0,0,25.34,82l59.83,39.88L75,132H56a12,12,0,0,0-8.48,3.51l-24,24a12,12,0,0,0,4,19.62l35.23,14.1,14.06,35.14.09.22a12,12,0,0,0,19.76,3.7l23.81-23.81A12,12,0,0,0,124,200V181l10.13-10.13L174,230.65a12,12,0,0,0,18.47,1.83l24-24a12,12,0,0,0,2.79-12.59Zm-4.11,89.85L146,145.33a12,12,0,0,0-8.8-5.28A11.66,11.66,0,0,0,136,140a12,12,0,0,0-8.49,3.52l-24,24A12,12,0,0,0,100,176v19l-7.62,7.62-9.24-23.1a12,12,0,0,0-6.69-6.69l-23.1-9.24L61,156H80a12,12,0,0,0,8.48-3.51l24-24A12,12,0,0,0,110.66,110L50.84,70.12l8.24-8.25,80.83,29.39a12,12,0,0,0,12.84-3.05l30.89-32.82a12,12,0,0,1,17,17l-32.82,30.89a12,12,0,0,0-3.06,12.84l29.4,80.82Z" }, null, -1), Z = [
  H
], w = { key: 1 }, M = /* @__PURE__ */ t("path", {
  ...
  setup(c) {
    const o = c, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), L = s("mirrored", !1), e = n(() => o.weight ?? d), i = n(() => o.size ?? _), A = n(() => o.color ?? h), u = n(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (r, q) => (l(), a("svg", m({
      ...
      g(r.$slots, "default"),
      e.value === "bold" ? (l(), a("g", f, Z)) : e.value === "duotone" ? (l(), a("g", w, V)) : e.value === "fill" ? (l(), a("g", x, z)) : e.value === "light" ? (l(), a("g", C, N)) : e.value === "regular" ? (l(), a("g", b, P)) : e.value === "thin" ? (l(), a("g", W, j)) : v("", !0)
    ], 16, y));
  }
});
export {
