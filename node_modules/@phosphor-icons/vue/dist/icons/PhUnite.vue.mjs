import { defineComponent as M, inject as s, computed as c, openBlock as t, createElementBlock as e, mergeProps as u, renderSlot as p, createCommentVNode as g, createElementVNode as o } from "vue";
const L = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M178,78A84,84,0,1,0,78,178,84,84,0,1,0,178,78Zm42,82a60.75,60.75,0,0,1-.38,6.65l-44-44a83.31,83.31,0,0,0,4-19.34A60.09,60.09,0,0,1,220,160Zm-74-30.94L126.94,110a59.57,59.57,0,0,1,28.9-9.81A59.57,59.57,0,0,1,146,129.06ZM110,126.94,129.06,146a59.57,59.57,0,0,1-28.9,9.81A59.57,59.57,0,0,1,110,126.94Zm42.7-50.6a83.31,83.31,0,0,0-19.34,4l-44-44A60.75,60.75,0,0,1,96,36,60.09,60.09,0,0,1,152.67,76.34ZM64.19,45.16l46.73,46.73a85,85,0,0,0-19,19L45.16,64.19A60.45,60.45,0,0,1,64.19,45.16ZM36,96a60.75,60.75,0,0,1,.38-6.65l44,44a83.31,83.31,0,0,0-4,19.34A60.09,60.09,0,0,1,36,96Zm67.33,83.66a83.31,83.31,0,0,0,19.34-4l44,44A60.75,60.75,0,0,1,160,220,60.09,60.09,0,0,1,103.33,179.66Zm88.48,31.18-46.73-46.73a85,85,0,0,0,19-19l46.73,46.73A60.45,60.45,0,0,1,191.81,210.84Z" }, null, -1), f = [
  y
  ...
  setup(r) {
    const l = r, A = s("weight", "regular"), Z = s("size", "1em"), d = s("color", "currentColor"), _ = s("mirrored", !1), a = c(() => l.weight ?? A), n = c(() => l.size ?? Z), h = c(() => l.color ?? d), m = c(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), e("svg", u({
      ...
      p(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", v, f)) : a.value === "duotone" ? (t(), e("g", w, x)) : a.value === "fill" ? (t(), e("g", S, B)) : a.value === "light" ? (t(), e("g", N, E)) : a.value === "regular" ? (t(), e("g", H, V)) : a.value === "thin" ? (t(), e("g", W, j)) : g("", !0)
    ], 16, L));
  }
});
export {
