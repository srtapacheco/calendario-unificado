import { defineComponent as g, inject as l, computed as s, openBlock as t, createElementBlock as e, mergeProps as m, renderSlot as Z, createCommentVNode as v, createElementVNode as o } from "vue";
const M = ["width", "height", "fill", "transform"], y = { key: 0 }, L = /* @__PURE__ */ o("path", { d: "M251.62,39.65a12,12,0,0,0-11.27-11.27c-53.28-3.14-96.2,13.37-114.84,44.14-12.14,20-12.56,44.17-1.46,67.3a75.21,75.21,0,0,0-11.24,20l-9.7-9.7c7.19-16.77,6.43-34.11-2.4-48.69C86.73,78.36,54.89,66,15.55,68.28A12,12,0,0,0,4.28,79.55C2,118.89,14.36,150.73,37.45,164.71a49.76,49.76,0,0,0,26,7.27,57.54,57.54,0,0,0,22.7-4.87L108,189v27a12,12,0,0,0,24,0V186.51a51.63,51.63,0,0,1,9.49-29.95A76.81,76.81,0,0,0,173.58,164a64.92,64.92,0,0,0,33.9-9.46C238.25,135.85,254.76,92.92,251.62,39.65ZM49.88,144.18c-13.19-8-21.18-27.46-21.83-52.13,24.67.65,44.14,8.65,52.13,21.83a26,26,0,0,1,3.63,17L72.48,119.51a12,12,0,0,0-17,17l11.34,11.34A26.27,26.27,0,0,1,49.88,144.18ZM195.05,134c-10.66,6.45-23,7.67-35.81,3.76l37.25-37.24a12,12,0,0,0-17-17l-37.25,37.24C138.37,108,139.59,95.61,146,85c12.77-21.09,43-33.07,82-33C228.14,91,216.14,121.18,195.05,134Z" }, null, -1), V = [
  L
], f = { key: 1 }, A = /* @__PURE__ */ o("path", {
  ...
  setup(r) {
    const c = r, d = l("weight", "regular"), _ = l("size", "1em"), h = l("color", "currentColor"), C = l("mirrored", !1), a = s(() => c.weight ?? d), n = s(() => c.size ?? _), u = s(() => c.color ?? h), p = s(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : C ? "scale(-1, 1)" : void 0);
    return (i, F) => (t(), e("svg", m({
      ...
      Z(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", y, V)) : a.value === "duotone" ? (t(), e("g", f, k)) : a.value === "fill" ? (t(), e("g", x, z)) : a.value === "light" ? (t(), e("g", B, P)) : a.value === "regular" ? (t(), e("g", b, W)) : a.value === "thin" ? (t(), e("g", $, q)) : v("", !0)
    ], 16, M));
  }
});
export {
