...
const M = ["width", "height", "fill", "transform"], g = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M208,52a91.68,91.68,0,0,0-29.9,5c-15.39-28.76-43.4-43.06-44.73-43.72a12,12,0,0,0-10.74,0c-1.33.66-29.34,15-44.74,43.72A91.57,91.57,0,0,0,48,52,12,12,0,0,0,36,64v80a92,92,0,0,0,184,0V64A12,12,0,0,0,208,52ZM60,77.06a68.15,68.15,0,0,1,55.72,60.73,91.89,91.89,0,0,0-55.72-29Zm56,133.88A68.12,68.12,0,0,1,60,144V133.06A68.12,68.12,0,0,1,116,200ZM99.37,67.71c8.2-14.94,21.32-25,28.63-29.77,7.32,4.79,20.43,14.83,28.63,29.77A92.69,92.69,0,0,0,128,98.61,92.8,92.8,0,0,0,99.37,67.71ZM196,144a68.12,68.12,0,0,1-56,66.94V200a68.12,68.12,0,0,1,56-66.94Zm0-35.22a91.89,91.89,0,0,0-55.72,29A68.15,68.15,0,0,1,196,77.06Z" }, null, -1), f = [
  ...
  setup(r) {
    const s = r, d = c("weight", "regular"), _ = c("size", "1em"), h = c("color", "currentColor"), A = c("mirrored", !1), a = n(() => s.weight ?? d), i = n(() => s.size ?? _), Z = n(() => s.color ?? h), m = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (l, F) => (t(), e("svg", p({
      ...
      V(l.$slots, "default"),
      a.value === "bold" ? (t(), e("g", g, f)) : a.value === "duotone" ? (t(), e("g", w, S)) : a.value === "fill" ? (t(), e("g", x, B)) : a.value === "light" ? (t(), e("g", N, E)) : a.value === "regular" ? (t(), e("g", P, $)) : a.value === "thin" ? (t(), e("g", j, q)) : v("", !0)
    ], 16, M));
  }
});
export {
