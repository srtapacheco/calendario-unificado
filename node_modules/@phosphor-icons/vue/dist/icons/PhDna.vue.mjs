import { defineComponent as p, inject as l, computed as n, openBlock as a, createElementBlock as t, mergeProps as H, renderSlot as g, createCommentVNode as v, createElementVNode as e } from "vue";
const m = ["width", "height", "fill", "transform"], M = { key: 0 }, Z = /* @__PURE__ */ e("path", { d: "M204,204.5V232a12,12,0,0,1-24,0V204.5a59.68,59.68,0,0,0-33.17-53.67l-48.4-24.2A83.54,83.54,0,0,1,52,51.5V24a12,12,0,0,1,24,0V51.5a59.68,59.68,0,0,0,33.17,53.67l48.4,24.2A83.54,83.54,0,0,1,204,204.5Zm-52-.5H76a59.75,59.75,0,0,1,2.34-16h56.2a12,12,0,0,0,0-24H91.76c1-1.1,2-2.18,3.13-3.21a12,12,0,0,0-16.45-17.48A84.38,84.38,0,0,0,52,204.5V232a12,12,0,0,0,24,0v-4h76a12,12,0,0,0,0-24ZM192,12a12,12,0,0,0-12,12v4H104a12,12,0,0,0,0,24h76a59.75,59.75,0,0,1-2.34,16H121.44a12,12,0,0,0,0,24h42.8c-1,1.1-2,2.18-3.13,3.21a12,12,0,0,0,16.45,17.48A84.38,84.38,0,0,0,204,51.5V24A12,12,0,0,0,192,12Z" }, null, -1), y = [
  Z
  ...
  setup(r) {
    const s = r, c = l("weight", "regular"), d = l("size", "1em"), V = l("color", "currentColor"), _ = l("mirrored", !1), o = n(() => s.weight ?? c), h = n(() => s.size ?? d), A = n(() => s.color ?? V), u = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, q) => (a(), t("svg", H({
      ...
      g(i.$slots, "default"),
      o.value === "bold" ? (a(), t("g", M, y)) : o.value === "duotone" ? (a(), t("g", f, x)) : o.value === "fill" ? (a(), t("g", S, C)) : o.value === "light" ? (a(), t("g", B, N)) : o.value === "regular" ? (a(), t("g", b, P)) : o.value === "thin" ? (a(), t("g", W, j)) : v("", !0)
    ], 16, m));
  }
});
export {
