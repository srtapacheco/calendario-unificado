...
const M = ["width", "height", "fill", "transform"], y = { key: 0 }, V = /* @__PURE__ */ o("path", { d: "M242.73,210.63l-56-112a12,12,0,0,0-21.46,0l-20.52,41A84.2,84.2,0,0,1,106,126.22,107.48,107.48,0,0,0,131.33,68H152a12,12,0,0,0,0-24H100V32a12,12,0,0,0-24,0V44H24a12,12,0,0,0,0,24h83.13A83.69,83.69,0,0,1,88,110.35,84,84,0,0,1,75.6,91a12,12,0,1,0-21.81,10A107.55,107.55,0,0,0,70,126.24,83.54,83.54,0,0,1,24,140a12,12,0,0,0,0,24,107.47,107.47,0,0,0,64-21.07,108.4,108.4,0,0,0,45.39,19.44l-24.13,48.26a12,12,0,1,0,21.46,10.73L143.41,196h65.17l12.68,25.36a12,12,0,1,0,21.47-10.73ZM155.41,172,176,130.83,196.58,172Z" }, null, -1), Z = [
  ...
  setup(h) {
    const l = h, d = s("weight", "regular"), c = s("size", "1em"), _ = s("color", "currentColor"), u = s("mirrored", !1), a = n(() => l.weight ?? d), i = n(() => l.size ?? c), p = n(() => l.color ?? _), A = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
    return (r, q) => (t(), e("svg", H({
      ...
      m(r.$slots, "default"),
      a.value === "bold" ? (t(), e("g", y, Z)) : a.value === "duotone" ? (t(), e("g", f, L)) : a.value === "fill" ? (t(), e("g", x, z)) : a.value === "light" ? (t(), e("g", C, N)) : a.value === "regular" ? (t(), e("g", b, P)) : a.value === "thin" ? (t(), e("g", W, j)) : v("", !0)
    ], 16, M));
  }
});
export {
