...
const A = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ e("path", { d: "M231.5,162.63a12,12,0,0,0-15,0C214,164.64,192,183,192,208a32,32,0,0,0,64,0C256,183,234,164.64,231.5,162.63ZM224,216a8,8,0,0,1-8-8c0-6.8,3.91-13.64,8-18.83,4.07,5.17,8,12,8,18.83A8,8,0,0,1,224,216Zm8.49-101L125,7.51a12,12,0,0,0-17,0L70.25,45.29,48.48,23.51a12,12,0,1,0-17,17L53.28,62.26,12.2,103.34a28,28,0,0,0,0,39.6L97.06,227.8a28,28,0,0,0,39.6,0L232.49,132A12,12,0,0,0,232.49,115Zm-112.8,95.83a4,4,0,0,1-5.66,0L29.17,126a4,4,0,0,1,0-5.66L70.25,79.23l21.27,21.26a36,36,0,1,0,17-17L87.23,62.26,116.52,33,207,123.48ZM124,104a12,12,0,1,1-12,12A12,12,0,0,1,124,104Z" }, null, -1), C = [
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), L = s("mirrored", !1), o = n(() => l.weight ?? d), c = n(() => l.size ?? _), Z = n(() => l.color ?? h), m = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (i, F) => (t(), a("svg", p({
      ...
      g(i.$slots, "default"),
      o.value === "bold" ? (t(), a("g", v, C)) : o.value === "duotone" ? (t(), a("g", f, S)) : o.value === "fill" ? (t(), a("g", x, B)) : o.value === "light" ? (t(), a("g", N, b)) : o.value === "regular" ? (t(), a("g", E, W)) : o.value === "thin" ? (t(), a("g", $, q)) : M("", !0)
    ], 16, A));
  }
});
export {
